<div class="actions">
    ...
    <ul class="nav nav-list">
        ...
        <g:set var="users" value="${createLink(controller: 'communauteUser', action:'list' , params: [communauteCode:user.communaute.code])}" />
        ...
        <li <g:if test="${current == users}" >class="active"</g:if> ><a href="${users}"><i class="icon-user <g:if test="${current == users}" >icon-white</g:if>"></i> Voir tous les membres</a></li>
