	...
	<body>
		...
		<div id="show-user" class="content scaffold-show" role="main">
			...
			<ol class="property-list user">
				...
				<li class="fieldcontain">
					<span id="communaute-label" class="property-label"><g:message code="user.communaute.label" default="Communaute" /></span>
					
						<span class="property-value" aria-labelledby="communaute-label"><g:link controller="communaute" action="show" id="${userInstance?.communaute?.id}">${userInstance?.communaute?.encodeAsHTML()}</g:link></span>
				...
				<g:if test="${userInstance?.passwordSalt}">
				<li class="fieldcontain">
					<span id="passwordSalt-label" class="property-label"><g:message code="user.passwordSalt.label" default="Password Salt" /></span>
